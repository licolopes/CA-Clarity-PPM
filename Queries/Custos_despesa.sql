SELECT VALORES.TRANSCLASS TIPO_DESPESA 
       , Sum(VALORES.ORCADO)                             ORCADO 
       , Sum(VALORES.REALIZADO)                          REALIZADO 
       , Sum(VALORES.REALIZADO) / ISNULL(NULLIF(ISNULL(NULLIF(Sum(VALORES.ORCADO),0),Sum(VALORES.REALIZADO)),0),1)    PCT_REALIZADO 
       , Sum(VALORES.COMPROMETIDO)                       COMPROMETIDO 
       , Sum(VALORES.COMPROMETIDO) / ISNULL(NULLIF(ISNULL(NULLIF(Sum(VALORES.ORCADO),0),Sum(VALORES.COMPROMETIDO)),0),1) PCT_COMPROMETIDO 
       , Sum(VALORES.PROJETADO)                          PROJETADO 
       , Sum(VALORES.PROJETADO) / ISNULL(NULLIF(ISNULL(NULLIF(Sum(VALORES.ORCADO),0),Sum(VALORES.PROJETADO)),0),1)    PCT_PROJETADO 

...
(
	...
	CASE
		...
		WHEN STATUS_FINAL = 'Cancelado' THEN 30
		WHEN STATUS_FINAL = 'On hold' THEN 40
		WHEN STATUS_FINAL = 'Extra' THEN 50
		WHEN STATUS_FINAL = 'Demanda Cancelada' THEN 60
		WHEN STATUS_FINAL = 'Demanda Atrasada' THEN 70
		WHEN STATUS_FINAL = 'Demanda No Prazo' THEN 80
		WHEN STATUS_FINAL = 'Demanda Futura' THEN 90
		WHEN STATUS_FINAL = 'Atrasado' THEN 100
		WHEN STATUS_FINAL = 'No Prazo' THEN 110
		END STATUS_ORDER,
	FASE,
	CASE
		WHEN STATUS_FINAL = 'Sem Status' THEN 10

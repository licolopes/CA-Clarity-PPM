SELECT   @SELECT:DIM:USER_DEF:IMPLIED:EXTRACAO:DISTINCT UNIQUE_ID:UNIQUE_ID@
		...
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:MOLECULA:MOLECULA@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:CONCENTRACAO:CONCENTRACAO@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:APRESENTACAO:APRESENTACAO@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:FORMA_FARMA:FORMA_FARMA@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:PROD_REF:PROD_REF@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:RAC_TERAP:RAC_TERAP@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:RAC:RAC@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:INV_ANO1:INV_ANO1@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:INV_ANO2:INV_ANO2@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:INV_ANO3:INV_ANO3@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:INV_ANO4:INV_ANO4@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:INV_ANO5:INV_ANO5@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:COM_MKT:COM_MKT@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:FCST_ANO_1:FCST_ANO_1@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:FCST_ANO_2:FCST_ANO_2@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:FCST_ANO_3:FCST_ANO_3@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:FCST_ANO_4:FCST_ANO_4@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:FCST_ANO_5:FCST_ANO_5@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:PRECO_FAB:PRECO_FAB@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:DESCONTO:DESCONTO@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:CARAC_PROD_ADQ:CARAC_PROD_ADQ@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:CARAC_PROD_COM:CARAC_PROD_COM@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:QUAL_EST_ADQ:QUAL_EST_ADQ@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:QUAL_EST_COM:QUAL_EST_COM@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:RAC_TERAP_ADQ:RAC_TERAP_ADQ@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:RAC_TERAP_VLR:RAC_TERAP_VLR@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:RAC_TERAP_COM:RAC_TERAP_COM@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:JUST_TEC_ADQ:JUST_TEC_ADQ@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:JUST_TEC_COM:JUST_TEC_COM@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:JUST_TEC_VLR:JUST_TEC_VLR@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:ELAB_DOS_ADQ:ELAB_DOS_ADQ@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:ELAB_DOS_VLR:ELAB_DOS_VLR@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:ELAB_DOS_COM:ELAB_DOS_COM@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:PRE_CLI_ADQ:PRE_CLI_ADQ@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:PRE_CLI_VLR:PRE_CLI_VLR@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:PRE_CLI_COM:PRE_CLI_COM@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:CLI_FAS1_ADQ:CLI_FAS1_ADQ@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:CLI_FAS1_VLR:CLI_FAS1_VLR@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:CLI_FAS1_COM:CLI_FAS1_COM@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:CLI_FAS2_ADQ:CLI_FAS2_ADQ@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:CLI_FAS2_VLR:CLI_FAS2_VLR@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:CLI_FAS2_COM:CLI_FAS2_COM@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:CLI_FAS3_ADQ:CLI_FAS3_ADQ@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:CLI_FAS3_VLR:CLI_FAS3_VLR@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:CLI_FAS3_COM:CLI_FAS3_COM@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:COM_AR_MEDIC:COM_AR_MEDIC@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:PET_ANVISA:PET_ANVISA@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:DOSSIE_TEC:DOSSIE_TEC@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:N_LOT_PIL:N_LOT_PIL@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:CATEGORIA_LANC:CATEGORIA_LANC@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:CUSTOS_TAX:CUSTOS_TAX@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:CUSTOS_TAX_COM:CUSTOS_TAX_COM@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:OUTROS_CUSTOS:OUTROS_CUSTOS@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:OUTROS_CUSTOS_COM:OUTROS_CUSTOS_COM@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:COM_AR:COM_AR@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:LOTE_PAD:LOTE_PAD@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:TESTE_BANC_VLR:TESTE_BANC_VLR@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:TESTE_BANC_COM:TESTE_BANC_COM@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:LOTE_PIL_VLR:LOTE_PIL_VLR@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:LOTE_PIL_COM:LOTE_PIL_COM@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:BIOEQ_VLR:BIOEQ_VLR@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:BIOEQ_COM:BIOEQ_COM@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:BIOD_VLR:BIOD_VLR@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:BIOD_COM:BIOD_COM@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:FERRA_VLR:FERRA_VLR@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:FERRA_COM:FERRA_COM@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:COD_SAP:COD_SAP@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:DESC_MAT:DESC_MAT@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:TEOR:TEOR@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:QTD:QTD@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:UNID_MED:UNID_MED@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:MET_ANA_VLR:MET_ANA_VLR@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:MET_ANA_COM:MET_ANA_COM@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:EQV_FARMA_VLR:EQV_FARMA_VLR@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:EQV_FARMA_COM:EQV_FARMA_COM@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:ESTAB_VLR:ESTAB_VLR@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:ESTAB_COM:ESTAB_COM@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:MAT_CONS_VLR:MAT_CONS_VLR@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:MAT_CONS_COM:MAT_CONS_COM@
		...
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:FCST_ANO_1_LANC:FCST_ANO_1_LANC@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:FCST_ANO_2_LANC:FCST_ANO_2_LANC@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:FCST_ANO_3_LANC:FCST_ANO_3_LANC@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:FCST_ANO_4_LANC:FCST_ANO_4_LANC@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:FCST_ANO_5_LANC:FCST_ANO_5_LANC@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:PRECO_FAB_LANC:PRECO_FAB_LANC@
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:DESCONTO_LANC:DESCONTO_LANC@
		...
		,@SELECT:DIM_PROP:USER_DEF:IMPLIED:EXTRACAO:MOTIVO_CANCEL:MOTIVO_CANCELS@
...
SELECT 
 ...
 , CONVERT(FLOAT,MKT_LANC.HM_MES1 + MKT_LANC.HM_MES2 + MKT_LANC.HM_MES3 + MKT_LANC.HM_MES4 + MKT_LANC.HM_MES5 + MKT_LANC.HM_MES6 +
   MKT_LANC.HM_MES7 + MKT_LANC.HM_MES8 + MKT_LANC.HM_MES9 + MKT_LANC.HM_MES10 + MKT_LANC.HM_MES11 + MKT_LANC.HM_MES12) FCST_ANO_1_LANC
 , CONVERT(FLOAT,MKT_LANC.HM_ANO2) FCST_ANO_2_LANC
 , CONVERT(FLOAT,MKT_LANC.HM_ANO3) FCST_ANO_3_LANC
 , CONVERT(FLOAT,MKT_LANC.HM_ANO4) FCST_ANO_4_LANC
 , CONVERT(FLOAT,MKT_LANC.HM_ANO5) FCST_ANO_5_LANC
 , CONVERT(FLOAT,MKT_LANC.HM_PCO_FAB) PRECO_FAB_LANC
 , CONVERT(FLOAT,MKT_LANC.HM_DESC) DESCONTO_LANC

...
(
  ...
  FROM 
    ...
    LEFT JOIN CMN_LOOKUPS_V PHASE ON OCINV.san_proj_phase = PHASE.LOOKUP_CODE AND PHASE.LOOKUP_TYPE='SAN_LKP_PROJ_PHASE' AND PHASE.LANGUAGE_CODE = 'en'
    ...
    LEFT JOIN CMN_LOOKUPS_V STAGE ON STAGE.LOOKUP_CODE = OCINV.SAN_STAGE_GATE AND STAGE.LOOKUP_TYPE = 'SAN_LKP_STAGE_GATE' AND STAGE.LANGUAGE_CODE = 'en'
